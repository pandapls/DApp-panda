...
class Assertions extends infrastructure_1.default {
    ...
    assertSeeIn(selector, text) {
        this.push(() => __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.default.ok(textContent && textContent.includes(text), `Expected text "${text}" cannot be found in element "${selector}".`);
        }), error_1.prepareStackTrace());
        return this;
    }
    assertDontSeeIn(selector, text) {
        this.push(() => __awaiter(this, void 0, void 0, function* () {
            ...
            /* istanbul ignore next, instrumenting cannot be executed in browser */
            element => element.textContent);
            assert_1.default.ok(textContent === null || !textContent.includes(text), `Unexpected text "${redify(text)}" was found in element "${selector}".`);
        }), error_1.prepareStackTrace());
        return this;
    }
